...
const BankingPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Banking - Capabilities | Hilbrick-Rockle LAW</title>
      ...
      <section className="relative h-[50vh] bg-gradient-to-br from-blue-900 to-indigo-900 text-white">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Banking</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">Our Banking practice provides comprehensive legal representation for clients across various industries and jurisdictions.</p>
