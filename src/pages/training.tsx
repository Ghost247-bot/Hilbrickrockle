...
const TrainingPage: React.FC = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative h-[50vh] bg-gradient-to-br from-indigo-900 via-indigo-800 to-indigo-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Training & Development</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            >
              <h3 className="text-xl font-bold mb-4 text-gray-900">Legal Skills Training</h3>
            ...
            <motion.div
              ...
              className="bg-gray-50 rounded-lg p-6"
            >
              <h3 className="text-xl font-bold mb-4 text-gray-900">Leadership Development</h3>
              <p className="text-gray-600">
            ...
            <motion.div
              ...
              className="bg-gray-50 rounded-lg p-6"
            >
              <h3 className="text-xl font-bold mb-4 text-gray-900">Technology & Innovation</h3>
              <p className="text-gray-600">
