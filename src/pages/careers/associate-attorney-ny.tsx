...
const AssociateAttorneyPage: React.FC = () => {
      ...
      <section className="relative h-[40vh] bg-gradient-to-br from-indigo-900 via-indigo-800 to-indigo-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Associate Attorney</h1>
            <p className="text-xl text-indigo-100">Corporate Law • Lincoln, Nebraska • Full-time</p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                We are seeking a motivated Associate Attorney to join our Corporate Law practice in Lincoln, Nebraska. 
                The successful candidate will work closely with partners and senior associates on a variety of corporate 
                matters including mergers and acquisitions, corporate governance, securities law, and business transactions.
              </p>
              
              <h3 className="text-xl font-bold mt-8 mb-4 text-gray-900">Key Responsibilities</h3>
              <ul className="list-disc pl-6 mb-6 text-gray-600 space-y-2">
                <li>Assist with due diligence in M&A transactions</li>
                <li>Draft and review corporate documents and agreements</li>
                <li>Research and analyze complex legal issues</li>
                <li>Prepare legal memoranda and client communications</li>
                <li>Participate in client meetings and negotiations</li>
                <li>Manage multiple projects and deadlines effectively</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600 space-y-2">
                ...
                <li>Active bar admission in Nebraska (or ability to waive in)</li>
                <li>1-3 years of experience in corporate law preferred</li>
                <li>Strong analytical, research, and writing skills</li>
                <li>Excellent attention to detail and organizational abilities</li>
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-600 space-y-2">
                ...
                <li>Professional development and mentoring opportunities</li>
...
export default AssociateAttorneyPage;
